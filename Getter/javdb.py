...
def getActor(htmlcode):  # //*[@id="center_column"]/div[2]/div[1]/div/table/tbody/tr[1]/td/text()
    ...
    # actorpage = html.xpath('//strong[contains(text(),"演員")]/../span/a/@href')
    # actor_list = []
    # for i in actorpage:
    #     actorhtmlcode = get_html('https://javdb.com' + i).replace(u'\xa0', u' ')
    #     if str(actorhtmlcode) == 'ProxyError':
    #         raise TimeoutError
    #     actorhtml = etree.fromstring(actorhtmlcode, etree.HTMLParser())
    #     actorcht = actorhtml.xpath('//span[@class="actor-section-name"]/text()')
    #     print(actorcht)
    #     actor_list.extend(actorcht)
    #     time.sleep(3)
    # return actor_list
